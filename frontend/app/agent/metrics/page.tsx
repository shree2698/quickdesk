        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-panel p-6 rounded-2xl border border-[#2a364f] space-y-2">
              ...
              <div className="text-3xl font-extrabold text-slate-900">{metrics.openTicketsCount}</div>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-[#2a364f] space-y-2">
              ...
              <div className="text-3xl font-extrabold text-slate-900">{metrics.resolvedTicketsCount}</div>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-[#2a364f] space-y-2">
              ...
              <div className="text-3xl font-extrabold text-slate-900">{metrics.aiOverridePercentage}%</div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-[#2a364f] space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {Object.entries(metrics.volumeByCategory || {}).map(([cat, count]: [string, any]) => (
                <div key={cat} className="p-4 rounded-xl border text-slate-200 text-center space-y-1">
